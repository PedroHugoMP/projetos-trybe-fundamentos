...
<details>
  ...
  * Data para entrega do projeto: `22/03/2023 14:00`.
...
1. Clone o repositório
  * Use o comando: `git clone git@github.com:tryber/sd-031-b-project-pixels-art.git`
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-031-b-project-pixels-art`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-031-b-project-pixels-art/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-031-b-project-pixels-art/pulls) e confira que o seu _Pull Request_ está criado
...
Link: [Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH31-B&template=betrybe/sd-0x-project-pixels-art)
