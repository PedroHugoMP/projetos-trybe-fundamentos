...
- Data para entrega do projeto: `24/04/2023 14:00`
...
1. Clone o repositório
	...
	*  Use o comando: `git clone git@github.com:tryber/sd-031-b-project-zoo-functions.git`

* Entre na pasta do repositório que você acabou de clonar:

	*  `cd sd-031-b-project-zoo-functions`
...
6. Crie um novo `Pull Request`  _(PR)_
	* Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-031-b-project-zoo-functions/pulls)
	...
	* Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-031-b-project-zoo-functions/pulls) e confira que o seu _Pull Request_ está criado.
