...
- Use o comando: `git clone git@github.com:tryber/sd-031-b-project-lessons-learned.git`
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-031-b-project-lessons-learned`
...
- Verifique que você está na raiz do projeto:
  - Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/maria/code/**sd-031-b-project-lessons-learned**_
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-031-b-project-lessons-learned/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-031-b-project-lessons-learned/pulls) e confira que o seu _Pull Request_ está criado
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH31-B&template=betrybe/sd-031-b-project-lessons-learned)
