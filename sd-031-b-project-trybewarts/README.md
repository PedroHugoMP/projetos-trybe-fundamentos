...
- Data para entrega regular do projeto: `30/03/2023 14:00`
...
- `git clone git@github.com:tryber/sd-031-b-project-trybewarts.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-031-b-project-trybewarts`
...
- Verifique se você está na raiz do projeto
  ...
  - Exemplo: `pwd` -> o retorno vai ser algo como _/Users/joao/code/**sd-031-b-project-trybewarts**_
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-031-b-project-trybewarts/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-031-b-project-trybewarts/pulls) e confira que o seu _Pull Request_ está criado
...
Link: [Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH31-B&template=betrybe/sd-0x-project-trybewarts)
